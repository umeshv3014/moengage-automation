...
import com.moengage.pageobjects.common.PageElement;
...
//   string in locator value
  public static PageElement modifyPageElementOnce(PageElement element,
...
//  }
  ...
  public static Calendar getRandomDOB(String passengerType, Calendar onwardCalendar) {
    Calendar calendar = Calendar.getInstance();
    int year = 0;
    int month = onwardCalendar.get(Calendar.MONTH);
    int date = 1;
    if (StringUtils.contains(passengerType, "adult")) {
      year = calendar.get(Calendar.YEAR) - RandomValues.getRandomNumberBetween(19, 39);
